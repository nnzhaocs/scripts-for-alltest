...
# siftcache* and prefetch are mostly based on docker-performance version of the same files
...
def main():
    ...
    cache_sz = int(max(args.percent * tot_sz, 5000))
    print(cache_sz)
    print(tot_sz)
    #time.sleep(5)
