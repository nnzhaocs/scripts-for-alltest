...
target platform which the image runs on and the \lrcomment{the following is unclear}
...
\lrcomment{describe what a repository is} and stores different versions, tagged
...
image and layer data \lrcomment{Is both image and layer data used to compute hash for
a layer?}.
%
