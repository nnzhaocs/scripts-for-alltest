...
However, looking at Figure~\ref{fig:compress-ratio},% and Figure~\ref{fig_hist_layer}
...
%90\%
%of layers have less than 1,146 directories  
...
Lastly, we look at file count in layers as shown in Figure~\ref{fig:file-cnt-cdf}.%and directory metrics in layers.  and~\ref{fig_dir_cnt} 
%Figure~\ref{fig:file-cnt-cdf} show the CDFs of file and
