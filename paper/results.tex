...
\begin{figure}[!t]
	...
	\subfigure[CDF of layers by layer size]{\label{fig_layer_size_cdf}
		\includegraphics[width=0.22\textwidth]{graphs/layer_size_mb.pdf}
	}
	\subfigure[Histogram of layers by layer size]{\label{fig_hist_layer_size}
		\includegraphics[width=0.23\textwidth]{graphs/hist_layer_size.pdf}
	}
...
\begin{figure}[!t]
	...
	\subfigure[CDF of layers by layer size]{\label{fig_cdf_compression_ratio}
		\includegraphics[width=0.22\textwidth]{graphs/cdf_compression_ratio.pdf}
	}
	\subfigure[Histogram of layers by layer size]{\label{fig_his_compression_ratio}
		\includegraphics[width=0.23\textwidth]{graphs/his_compression_ratio.pdf}
	}
