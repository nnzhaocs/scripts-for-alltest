...
\begin{figure}
	...
	\subfigure[CDF of intra-layer redundant ratio in terms of file count]{\label{fig:per_layer_ratio_fcnt_cdf}
		\includegraphics [width=0.5\textwidth]{graphs/per_layer_ratio_fcnt_cdf.eps}
	}
	\subfigure[PDF of intra-layer redundant ratio in terms of file count]{\label{fig:per_layer_ratio_fcnt_pdf}
