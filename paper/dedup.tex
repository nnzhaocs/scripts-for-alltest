...
\begin{figure}
	...
	\subfigure[CDF of intra/inter-layer redundant ratio in terms of file count/capacity]{\label{fig:dedup_cdf}
		\includegraphics [width=0.5\textwidth]{graphs/dedup_cdf}
	}
	\subfigure[Histogram of intra/inter-layer redundant ratio in terms of file count/capacity]{\label{fig:dedup_hist}
		\includegraphics [width=0.5\textwidth]{graphs/dedup_hist}
	}
	\caption{Redundant ratio}
	\label{fig:dedup_cdf_and_hist_layer}
\end{figure}
