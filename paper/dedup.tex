...
\begin{figure}
	\centering
	\subfigure[CDF of intra/inter-layer redundant ratio in terms of file count/capacity]{\label{fig:layer-dedup_cdf}
		\includegraphics [width=0.5\textwidth]{graphs/layer-dup-ratio-cdf}
	}
	\subfigure[Histogram of intra/inter-layer redundant ratio in terms of file count/capacity]{\label{fig:layer-dedup_hist}
		\includegraphics [width=0.5\textwidth]{graphs/layer-dup-ratio-pdf}
	}
...
\begin{figure}
	...
	\subfigure[CDF of intra/inter-image redundant ratio in terms of file count/capacity]{\label{fig:image-dedup_cdf}
		\includegraphics [width=0.5\textwidth]{graphs/image-dup-ratio-pdf}
	}
	\subfigure[Histogram of intra/inter-image redundant ratio in terms of file count/capacity]{\label{fig:image-dedup_hist}
		\includegraphics [width=0.5\textwidth]{graphs/image-dup-ratio-cdf}
	}
	\caption{Image redundant ratio}
	\label{fig:image-dedup_cdf_and_hist_layer}
\end{figure}
