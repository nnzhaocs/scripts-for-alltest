...
can be retrieved via \lrcomment{add how to list official repos}. However, the majority
of repositories in Docker Hub are non-official repositories (around \lrcomment{add number}).
...
%
However, the obtained list contained duplicate entries because \lrcomment{Why?}.
%
