...
the metadata information for each subdirectory. Note that we analyzed 91.2\% of 
...
directory count;
file count;
layer directory depth (i.e., the maximum containing directory depth)
