...
We used Docker registry client API~\vcomment{insert the name, \nancomment{it is called Docker registry client API}} library~\cite{docker-registry-library} to simultaneously
