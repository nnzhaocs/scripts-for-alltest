...
\subsection{Deduplication of layers}
...
%\paragraph{Suggestions for performance improvements}
...
We wrote around 600 lines of Python code to simulate file-level deduplication
...
To quantify the run time to perform file-level deduplication, we simulate a
...
requests to the cold layers. Similarl to deduplication, to simulate pull layer
