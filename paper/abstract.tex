...
that occupy over \vcomment{XXX}TB.
%
...
%
In this study, we downloaded over \vcomment{XXX}TB of real Docker images,
analyzed their content, and derived major trends and useful insights.
%
For example, we found that \vcomment{XXX}.
%
...
unique.
%
We therefore designed and implemented a simulation of Docker registry that
