...
runtime.
%
Docker registry stores images and allows users to exchange them between each
other.
%
The amount of data Docker registries store is massive; Docker Hub, for
instance, stores at least half million public images.
%
...
%
%
We utilize this massive dataset to study storage-centric properties of
...
%
We downloaded over 50TB of images from Docker Hub and performed the first
in-depth analysis of these images.
%
