...
%as an alternative to the virtual
...
%framework and high available Docker image distribution mechanism, i.e., Docker registry. 
...
%
%To reduce duplicates and improve storage efficiency, i
...
%that exist within an individual layer and across different layers.  
