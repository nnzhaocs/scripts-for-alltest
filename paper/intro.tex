...
\vcomment{ Why usefull?  Registry design, overall Docker improvements,
Understand what data people store in general Use cases: - Containerize every
user application (like git).  - Containerize services.  - Containerize whole
OSes}
%
