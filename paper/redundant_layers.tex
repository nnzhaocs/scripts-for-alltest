...
\acomment{Found the following para later in directory count..}
...
%any given layer size) while compressed layers are typically smaller.  j
...
%
%Half of the layers have a compression ratio (both ALS-to-CLS and FLS-to-CLS)
%around 3.
%
%
