...
%	}
   ...
   \label{fig:client-repull-cdf}
	...
	\caption{CDF of \texttt{GET} layer request count and client repulling probability. \Ali{Please rename "Layer repull count"  to "GET Layer count" in figure.}\VT{Also, Y axis label, can
 we change it to "Layers ratio" and "Clients ratio"?}}
	\label{fig-repull}
\end{figure}
