...
\begin{figure}[!t]
	\centering
	\subfigure[\texttt{GET} Layer count]{
		\includegraphics[width=0.22\textwidth]{graphs/cdf-layer-repull-by-same-client.pdf}
		\label{fig:layer-repull-cdf}
	}
...
%		\label{fig:repo-repull-cdf}
%	}
	\subfigure[Layer repulling probability]{
	\includegraphics[width=0.2\textwidth]{graphs/cdf-client-repull-layer-request-ratio.pdf}
   \label{fig:client-repull-cdf}
}
	\caption{CDF of client's layer repulling count and repulling probability. \Ali{Please rename "Layer repull count"  to "GET Layer count" in figure.}}
	\label{fig-repull}
\end{figure}
