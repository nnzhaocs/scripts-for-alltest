...
Skourtis \etal~\cite{skourtis2019carving} propose to reduce registry storage utilization by
...
%
These methods are orthogonal to our approach and can be use with \sysname.
%
