...
\sysname as shown in Figure~\ref{fig:tieredstore} \Subil{We say 5-tier here but 2-tier in the figure. Must change one or the other for consistency along with any other mentions of 2-tier/5-tier in the paper}.
\NZ{can we say 2-tier with 5-level?} \Subil{that works too}
