...
\sysname as shown in Figure~\ref{fig:tieredstore}, split into two tiers. \Subil{We say 5-tier here but 2-tier in the figure. Must change one or the other for consistency along with any other mentions of 2-tier/5-tier in the paper}.
...
\LR{Add details on on what ARC does exactly. How does it adapt? Why did we choose ARC?} \Subil{addressed, but may need editing}
...
so LFU is also needed.}\Subil{incorporated the reasons into text}
