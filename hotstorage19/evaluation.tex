...
%\subsection{}
\cite{xxx} conducts an comprehensive analysis of our whole dataset that is downloaded from Docker Hub. 
...
Due to our testbed cluster's scaling restriction, we set a limit to the layer size %\emph{layer size limitation} 
at 250 MB. 
