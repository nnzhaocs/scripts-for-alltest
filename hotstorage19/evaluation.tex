...
%
Before each experiment, we warm-up P-servers and D-servers with the unique layers as shown in
Table~\ref{tab:eval-overall} and then replay the first 5,000 requests from each workload.
Note that we do not warm-up the caches.
%
