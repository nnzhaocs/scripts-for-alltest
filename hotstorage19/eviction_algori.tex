...
\begin{algorithm}
	...
	\label{alg:eviction}
	\KwIn{\\
		$\theta_{C}$: Capacity threshold for diskcache to trigger replacement. \\
		...
		$\theta_{t}$: Expiration time determines for how long the layer stays in diskcache.
	}
	
	\ForEach{layer in LFRUlayer} 
	{
		{\tiny $/*$\textit{Remove expired layer */}} \\
		\If{layer.elapsed $>$ $\theta_{t}$}
			{
				\texttt{Evict} layer \\
			}
	}
