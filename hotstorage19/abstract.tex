...
The inability to effeciently and effectively deduplicate 
...
a high hit ratio of 96\%. Moreover, the two-tier cache is able to store 56\% more layers into the file cache.
