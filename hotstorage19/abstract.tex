...
pressure on the registries, which store and serve images. And 
the large volume of Docker images stored in registries is the key obstacle
...
While the rest deduplication modes
allow to trade off performance and data reduction.
