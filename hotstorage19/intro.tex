...
Docker, an enterprise container platform, 
 leverages LXC (Linux Containers), which consists of Linux kernel features such as cgroups and namespaces for efficient process isolation and resource control, support multitenancy. 
...
kubernetes self- healing, auto restarting, replication and rescheduling mechanisms make it more robust and suitable for container based application.
Docker registry
