...
%Drivers provide a means of interfacingun
...
%This is a radical departure from the traditional “backup to the graveyard” approach which is written as a serial stream of incremental or full backups.
...
If decompression and file-level deduplication is applied on the dataset, % subil: citation needed
...
%uses a cache that takes into consideration the user behavior and layer popularity, 
%in addition to parallelizing layer construction across %HA?
%servers.
