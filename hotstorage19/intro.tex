...
Microsoft Azure~\cite{xxx}, OpenStack Swift~\cite{xxx}, and Aliyun OSS~\cite{xxx} as their backend storage systems.
...
Many cloud storage system \NZ{to be continue}
...
Therefore, in this paper, we propose a low restore latency %adaptive%
