...
Microsoft Azure~\cite{azure}, OpenStack Swift~\cite{swift}, and Aliyun OSS~\cite{aliyun} as their backend storage systems as shown in Figure~\ref{fig:without-dedup}.
