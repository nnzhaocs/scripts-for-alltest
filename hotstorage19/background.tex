...
%==================removed because we described docker image layer in intro.
...
%As pointed out in ~\cref{sec:intro}, service providers often use geographically distributed registries for faster access, e.g., IBM's Container Registry setup spans five regions~\cite{dockerworkload}. 
