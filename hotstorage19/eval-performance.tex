...
as the overhead for reconstructing non-cached layers increases\Subil{are you saying that ARC cache overhead is 16\% less than the no cache overhead for 9MB layers?}.
%
