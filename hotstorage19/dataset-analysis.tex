...
\subsection{Predictable User Access} \input{fig-repull-analysis}

\paragraph{User access patterns} When a Docker client \texttt{pulls} an image
...
\paragraph{Pull once VS. Always pull} Figure~\ref{fig:layer-repull-cdf} shows
the CDF of layer \texttt{pull} count by the same clients. 
%Here, \emph{repulling} indicates the act of pulling layers that have been
%pulled by the user before because they are no longer present on the user side.
