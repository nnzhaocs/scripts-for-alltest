...
In Figure~\ref{fig:cacheefficiency}, the x-axis values correspond to the sizes of $5$ random samples of registry data of varying sizes. For a traditional registry, the compressed layer tarballs will be kept as is.
...
This verifies the benefit of deduplicating layers when the dataset is large.
