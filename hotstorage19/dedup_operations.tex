...
In the followin, we explain Docker operations integration with \sysname.
...
Once the \texttt{pull slice} layer request is received, each destination server will initiate a layer slice restoring process 
...
Moreover, these systems should also be modified to restore layer slices in parallel. 
