...
This paper presents \sysname~that integrates caching, and deduplication with Docker registry to
...
Next, we present some issues or concerns about~\sysname~and additional optimizations to help speed up~\sysname:
