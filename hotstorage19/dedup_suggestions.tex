...
\paragraph{How to further utilize user behavior pattern to accurately predict layer access pattern }
\HA{my thoughts}
...
\paragraph{Client-side deduplication: viability and implications}
Client-side deduplication would affect container runtime.\HA{how?}
In the future work, we will offload client-side deduplication to server side\HA{here you are assuming we are doing client-side deduplication}, meaning that
