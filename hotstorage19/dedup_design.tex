...
However, based on our trace\HA{we have to mention which trace} analysis, only half of PULL layer requests have a precedent PUT layer request within the trace collecting duration of 75 days. 
This means that,
