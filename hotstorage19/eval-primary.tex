...
B mode 2 and B mode 1, the number of P-servers is set to six and three, respectively.
%In addition, 
...
This is because for \emph{S mode}, the hot layers have three replicas and are distributed across a 6-node primary cluster, which improves the overall performance.
...
As shown in Figure~\ref{fig:eval-total-traces}, because of layer restoring overhead, \emph{B mode 0} increases the \texttt{GET} layer latency by 39\% and 80\% on average for the \texttt{Fra} and \texttt{Lon} workloads, respectively.
