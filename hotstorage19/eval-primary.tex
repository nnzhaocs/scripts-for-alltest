...
Therefore, \emph{B mode 3} outperforms \emph{BOLT} for both the \texttt{Fra} and \texttt{Lon} traces. \Subil{I think there needs to be at least some mention of Dal and Syd?}
