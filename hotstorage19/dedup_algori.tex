...
We set a timer for each cached layer and 
we evict the layers when its timer $>$ $U_{thresh}$.
To incorporate the prefetch algorithm with our two-tier heterogeneous cache,
