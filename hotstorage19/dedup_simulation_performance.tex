...
Our user-based cache in the registry can improve the performance of the entire system
by hiding the long latency imposed by the backend dedup system.
Next, we present the preliminary evaluation of our user-based cache.
