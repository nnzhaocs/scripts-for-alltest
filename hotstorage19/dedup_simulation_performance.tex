...
We observe that only a few peak periods fill the cache because of the increase in number of users connected and the highly populated repositories requested. 
This means, user accesses are non-uniform with peaks and troughs, and our algorithm adapts to workload changes.
