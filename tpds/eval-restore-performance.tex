...
We breakdown \sysname's layer restoring performance in \emph{B-mode 0} with 32 clients on a 21-node cluster as shown in Figure~\ref{xxx}.% by using different number of D-servers.
