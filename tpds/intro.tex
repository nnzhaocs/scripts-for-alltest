...
%while keeping up with the demand.
...
with others.
%
%Hence, images are likely to benefit from deduplication.
%
...
%exploit this high data redundancy
%across layers.
...
%
%
%While existing deduplication methods can be applied, they
...
%\NZ{for highest data reduction mode, the performance degradation is up to 80\% of 
%state-of-the-art while the highest performance mode doesn't save space}
