...
%
Container images are similar with virtual machine images in the sense that they all serve as OS snapshots. 
%
Difference users might choose similar OS and run similar applications, which incurs a considerable redundancy across different container images.
%
