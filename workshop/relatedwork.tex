...
Docker storage has started to recieve attentsion from the community~\cite{dockerssd}.
%
\VT{Let's cite here in the list all Docker storage papers.}
%
...
%
\VT{need to reference our FAST 2018 paper}

\VT{Add 1--2 sentence on dedup dataset studies}
