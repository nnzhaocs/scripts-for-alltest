...
% 
In addition to Google Test, we also found source codes of go-ethereum~\cite{xxx} project, PostgreSQL~\cite{xxx}, Android Native Development Kit (NDK)~\cite{xxx}, xnu-chroot-environment~\cite{xxx}, etc. 
%
