...
%\paragraph{Deduplication for common file types}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.23\textwidth]{graphs/dedup-overall}
%	\caption{Overall deduplication ratio.
%	}
%	\label{}
%\end{figure}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.23\textwidth]{graphs/dedup-eol}
%	\caption{Deduplication results for EOL files.
%	}
%	\label{fig:dedup-eol}
%\end{figure}
...
\begin{figure}
	...
	\caption{\nancomment{Deduplication results for scripts}.
	}
...
\begin{figure}
	...
	\caption{\nancomment{Deduplication results for documents}.
	}
	\label{fig:dedup-doc}
\end{figure}
