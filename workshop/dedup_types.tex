...
%
Interestingly, we found there are multiple repositories \DIM{Docker repositories?} related to Google
...
\textit{Finding 2 \DIM{Where is Finding 1?}: All common file types have a high deduplication ratio.
