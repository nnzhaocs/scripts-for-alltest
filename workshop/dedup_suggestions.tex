...
We propose additional optimizations that can help to speed \sysname\ up:
...
from the Docker Hub more than 360 times from the time when the image is first pushed to Docker Hub
