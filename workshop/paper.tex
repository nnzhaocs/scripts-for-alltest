...
\newcommand{\AB}[1]{\noindent\textcolor{red}{\bf $\blacksquare$ Ali: #1}}
\newcommand{\LR}[1]{\noindent\textcolor{olive}{\bf $\blacksquare$ Lukas: #1}}
\newcommand{\DIM}[1]{\noindent\textcolor{pink}{\bf $\blacksquare$ Dimitris: #1}}
...
\title{Registry-diet: Store Less, Weight-Loss Secrets for Docker Registry}
...
\input{methodology}
%\input{char}
\input{dedup_analysis}
%\input{redundant_files}
%\input{redundant_images}
\input{file_addressable}
%\input{char}
\input{relatedwork}
\input{conclusion}
