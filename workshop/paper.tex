...
\title{Registry Diet: Weight Loss Secrets for Docker Registry\\
Weight Loss Secrets for Docker Registry\\
Slimmer: Weight Loss Secrets for Docker Registry\\
...
\VT{Don't forget that we need to add authors. The submission is not anonymous.}
