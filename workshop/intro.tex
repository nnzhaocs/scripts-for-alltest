...
%indicates that Docker developers are prone to replicate source codes or scripts (i.e., code reuse). 
%Moreover, these source code duplicates and script duplicates would result in more executable duplicates and object file duplicates.
...
%we propose a file-level content addressable storage model (\sysname\
...
%
%We simulate \sysname\ for 0.9 million layers and provide different suggestions to improve
