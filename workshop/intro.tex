...
Finally, we proposed a file-level content addressable storage model (FLCAS) for Docker registry, which. 
%
We simulated FLCAS by using xxx
The simulation result shows that xxx
