...
%
We downloaded 47TB (167TB uncompressed) worth of Docker Hub images,
%
...
Given our findings, we propose a file-level content addressable storage
model---\sysname---for the Docker registry.
%
...
%
To assess the feasibility of our design, we conducted a simulation-based
evaluation of \sysname. 
%
The simulation results show that \sysname\ improves deduplication
