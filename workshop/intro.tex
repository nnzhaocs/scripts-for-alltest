...
%
While \sysname\ comes with some overhead when retrieving layers from the registry
due to the additional decompression and reconstruction of layers, we find that for
layers less than 10\,MB (around 60\% of all layers) the overhead is less than 1\,s.
