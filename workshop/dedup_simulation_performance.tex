...
searches completing in less than 4ms and the median of \VT{3.9}ms.
%
...
%
However, after that, the times diverge and NZ{de}compression times increase faster
...
%
Overall, we see that 90\% of file-level deduplication time is less than \VT{35}s
per layer, while the average processing time for a single layer is \VT{13.5}s.
%
