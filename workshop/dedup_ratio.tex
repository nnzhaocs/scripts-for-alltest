...
%
In fact, some existing containerization frameworks~\cite{singularity}~\cite{openvz} \VT{cite singularity and
openvz}\NZ{addressed} use flat images.
%
...
%
\VT{Our investigation showed  that these layers are~, Verify this
sentence and extend with analysis.}\NZ{addressed}
