...
In Docker registry, layers are sharing among different images to avoid storing layer duplicates. 
...
and how much space was saved by using layer-level content addressable store.
Another interesting question is what is the remaining redundant data cross images.
Is layer-level content addressable enough for Docker registry to mitigate redundancy?
